    ...
    <OceanBackground>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.appInfoContainer}>
          <Text style={styles.appInfoTitle}>Ocean Academy</Text>
          <Text style={styles.appInfoText}>
            Discover the fascinating world of marine biology and oceanography. 
            Learn about ocean ecosystems, marine life, and conservation through interactive lessons and stories.
          </Text>
