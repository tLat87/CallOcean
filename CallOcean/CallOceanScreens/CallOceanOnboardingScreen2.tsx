  ...
  return (
    <OceanBackground>
      ...
      <View style={styles.content}>
        ...
        {/* Character area */}
        <Image source={require('../CallOceanAssets/img/846d80425b8da3bbbd1a55e0f69987bc2474a7e7.png')} style={{width: 300, height: 450, position: 'absolute', bottom: -150, alignSelf: 'center'}} />
      </View>
